package com.kathir.roomdbexample.adapter;
...
import com.kathir.roomdbexample.view.EditNoteActivity;
import com.kathir.roomdbexample.view.MainActivity;
...
public class NoteModelAdapter extends RecyclerView.Adapter<NoteModelAdapter.NoteViewHolder> {
    ...
    public NoteModelAdapter(Context context, OnDeleteClickListener listener) {
